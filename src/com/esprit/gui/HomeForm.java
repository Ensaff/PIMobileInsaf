...
this.getToolbar().addCommandToRightBar(new Command("PDF") {
 ...
 public void addItem(Produit produit) {
   ...
   Container c4 = new Container(BoxLayout.x());
    ...
    dialog.setLayout(new BoxLayout(BoxLayout.Y_AXIS)); // Utilisation du layout BoxLayout avec orientation verticale
    ...
    // Ajout d'un Container pour centrer les boutons
...
modifierButton.addActionListener((evt) -> {
    ...
    okButton.addActionListener((e) -> {
        ...
        ModifierProduitForm modifierForm = new ModifierProduitForm(HomeForm.this, produit);
        modifierForm.show();
    });
 ...
 public void updateProduits() {
    ...
    List<Produit> produits = sp.afficher();
    for (Produit produit : produits) {
        addItem(produit); // Ajouter chaque produit à la liste
    }
    revalidate(); // Redessiner le formulaire pour refléter les changements
}
